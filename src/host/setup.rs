...
use crate::database::update::{update_round_config, setting_tournament_config, update_round_1};
...
pub async fn start_tournament(
    ...
    update_round_config(ctx, region, None).await?;
    insert_mannequins(ctx, region, byes).await?;
    msg.edit(*ctx, |s| 
      s.embed(|e| {
        e.title("Setting up tournament")
        .description(format!("{}\n{}\n{}{}\n{}{}\n{}{}\n{}", prompts[0], prompts[1],prompts[3], &count, prompts[7], &rounds, prompts[5], &byes,  prompts[8]))
      })
    ).await?;
    ...
    msg.edit(*ctx, |s| 
      s.embed(|e| {
        e.title("Setting up tournament")
        .description(format!("{}\n{}\n{}{}\n{}{}\n{}{}\n{}", prompts[0], prompts[1],prompts[3], &count, prompts[7], &rounds, prompts[5], &byes,  prompts[9]))
      })
    ).await?;
